...
class DeviceRegisterRequest extends \Google\Protobuf\Internal\Message
{
    ...
    protected $token = '';
    /**
     * Generated from protobuf field <code>string platform = 4 [json_name = "platform"];</code>
     */
    protected $platform = '';
    /**
    ...
    protected $user = '';
    /**
     * Generated from protobuf field <code>map<string, string> meta = 6 [json_name = "meta"];</code>
     */
    private $meta;
    /**
     * Generated from protobuf field <code>repeated string topics = 7 [json_name = "topics"];</code>
     */
    private $topics;
    /**
     * Generated from protobuf field <code>string timezone = 8 [json_name = "timezone"];</code>
     */
    protected $timezone = '';
    /**
     * Generated from protobuf field <code>string locale = 9 [json_name = "locale"];</code>
     */
    protected $locale = '';
