...
class DeviceRemoveResponse extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>.centrifugal.centrifugo.api.DeviceRemoveResult result = 2 [json_name = "result"];</code>
     */
     ...
     * @return $this
     */
    public function setResult(\RoadRunner\Centrifugal\API\DTO\V1\DeviceRemoveResult|null $var)
    {
        $this->result = $var;
