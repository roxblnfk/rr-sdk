...
{
    /**
     * Generated from protobuf field <code>repeated .centrifugal.centrifugo.api.UserTopic items = 1 [json_name = "items"];</code>
     */
    private $items;
    /**
     * Generated from protobuf field <code>string next_cursor = 2 [json_name = "nextCursor"];</code>
     */
     ...
     *
     *     @type \RoadRunner\Centrifugal\API\DTO\V1\UserTopic[] $items
    ...
    /**
     * Generated from protobuf field <code>repeated .centrifugal.centrifugo.api.UserTopic items = 1 [json_name = "items"];</code>
     * @return RepeatedField<\RoadRunner\Centrifugal\API\DTO\V1\UserTopic>
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .centrifugal.centrifugo.api.UserTopic items = 1 [json_name = "items"];</code>
     * @param \RoadRunner\Centrifugal\API\DTO\V1\UserTopic[] $var
     * @return $this
     */
