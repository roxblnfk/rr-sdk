...
class UserTopicUpdateResponse extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>.centrifugal.centrifugo.api.UserTopicUpdateResult result = 2 [json_name = "result"];</code>
     */
     ...
     * @return $this
     */
    public function setResult(\RoadRunner\Centrifugal\API\DTO\V1\UserTopicUpdateResult|null $var)
    {
        $this->result = $var;
