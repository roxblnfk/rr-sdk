...
{
    /**
     * Generated from protobuf field <code>int64 time_ms = 1 [json_name = "timeMs"];</code>
     */
    protected $time_ms = 0;
    /**
     * Generated from protobuf field <code>string channel = 2 [json_name = "channel"];</code>
     */
    protected $channel = '';
    /**
     ...
     * @return $this
     */
    public function setTimeMs(int|string $var)
    {
