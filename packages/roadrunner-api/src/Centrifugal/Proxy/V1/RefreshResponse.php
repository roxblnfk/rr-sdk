...
{
    /**
     * Generated from protobuf field <code>.centrifugal.centrifugo.proxy.RefreshResult result = 1 [json_name = "result"];</code>
     */
     ...
     * @return $this
     */
    public function setResult(\RoadRunner\Centrifugal\Proxy\DTO\V1\RefreshResult|null $var)
    {
        $this->result = $var;
