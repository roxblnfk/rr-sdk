...
{
    /**
     * Generated from protobuf field <code>.centrifugal.centrifugo.proxy.SubRefreshResult result = 1 [json_name = "result"];</code>
     */
     ...
     * @return $this
     */
    public function setResult(\RoadRunner\Centrifugal\Proxy\DTO\V1\SubRefreshResult|null $var)
    {
        $this->result = $var;
     ...
     * @return $this
     */
    public function setError(\RoadRunner\Centrifugal\Proxy\DTO\V1\Error|null $var)
    {
        $this->error = $var;
     ...
     * @return $this
     */
    public function setDisconnect(\RoadRunner\Centrifugal\Proxy\DTO\V1\Disconnect|null $var)
    {
        $this->disconnect = $var;
