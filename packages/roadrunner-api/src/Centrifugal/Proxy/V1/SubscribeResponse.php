...
{
    /**
     * Generated from protobuf field <code>.centrifugal.centrifugo.proxy.SubscribeResult result = 1 [json_name = "result"];</code>
     */
     ...
     * @return $this
     */
    public function setResult(\RoadRunner\Centrifugal\Proxy\DTO\V1\SubscribeResult|null $var)
    {
        $this->result = $var;
