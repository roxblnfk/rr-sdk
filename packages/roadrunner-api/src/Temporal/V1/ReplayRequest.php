...
{
    /**
     * Generated from protobuf field <code>.temporal.api.common.v1.WorkflowExecution workflow_execution = 1 [json_name = "workflowExecution"];</code>
     */
    ...
    /**
     * Generated from protobuf field <code>string save_path = 3 [json_name = "savePath"];</code>
     */
    protected $save_path = '';
    /**
     * Generated from protobuf field <code>int64 last_event_id = 4 [json_name = "lastEventId"];</code>
     */
     ...
     * @return $this
     */
    public function setSavePath(string $var)
    {
     ...
     * @return $this
     */
    public function setLastEventId(int|string $var)
    {
