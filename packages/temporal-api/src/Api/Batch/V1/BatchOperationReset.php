...
class BatchOperationReset extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.temporal.api.common.v1.ResetOptions options = 4 [json_name = "options"];</code>
     */
    protected $options = null;
    /**
     * Deprecated. Use `options`.
     *
     * Generated from protobuf field <code>.temporal.api.enums.v1.ResetType reset_type = 1 [json_name = "resetType", deprecated = true];</code>
     * @deprecated
     */
     ...
     * Deprecated. Use `options`.
     *
     * Generated from protobuf field <code>.temporal.api.enums.v1.ResetReapplyType reset_reapply_type = 2 [json_name = "resetReapplyType", deprecated = true];</code>
     * @deprecated
     */
     ...
     *
     * Generated from protobuf field <code>repeated .temporal.api.workflow.v1.PostResetOperation post_reset_operations = 5 [json_name = "postResetOperations"];</code>
     */
