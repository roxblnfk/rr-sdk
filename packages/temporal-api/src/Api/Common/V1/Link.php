...
class Link extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>.temporal.api.common.v1.Link.WorkflowEvent workflow_event = 1 [json_name = "workflowEvent"];</code>
    ...
    /**
     * Generated from protobuf field <code>.temporal.api.common.v1.Link.BatchJob batch_job = 2 [json_name = "batchJob"];</code>
