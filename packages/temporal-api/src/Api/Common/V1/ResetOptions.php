...
class ResetOptions extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.temporal.api.enums.v1.ResetReapplyType reset_reapply_type = 10 [json_name = "resetReapplyType", deprecated = true];</code>
     * @deprecated
     */
     ...
     *
     * Generated from protobuf field <code>bool current_run_only = 11 [json_name = "currentRunOnly"];</code>
     */
    protected $current_run_only = false;
    /**
     * Event types not to be reapplied
     *
     * Generated from protobuf field <code>repeated .temporal.api.enums.v1.ResetReapplyExcludeType reset_reapply_exclude_types = 12 [json_name = "resetReapplyExcludeTypes"];</code>
     */
     ...
     * Resets to the first workflow task completed or started event.
     *
     * Generated from protobuf field <code>.google.protobuf.Empty first_workflow_task = 1 [json_name = "firstWorkflowTask"];</code>
     ...
     * Resets to the last workflow task completed or started event.
     *
     * Generated from protobuf field <code>.google.protobuf.Empty last_workflow_task = 2 [json_name = "lastWorkflowTask"];</code>
     * @return \Google\Protobuf\GPBEmpty|null
     */
     ...
     * Note that this option doesn't make sense when used as part of a batch request.
     *
     * Generated from protobuf field <code>int64 workflow_task_id = 3 [json_name = "workflowTaskId"];</code>
     * @return int|string
     */
     ...
     * continue-as-new.
     *
     * Generated from protobuf field <code>string build_id = 4 [json_name = "buildId"];</code>
     * @return string
     */
