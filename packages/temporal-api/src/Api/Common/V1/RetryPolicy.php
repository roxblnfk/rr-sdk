...
class RetryPolicy extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.protobuf.Duration initial_interval = 1 [json_name = "initialInterval"];</code>
     */
     ...
     * Must be 1 or larger.
     *
     * Generated from protobuf field <code>double backoff_coefficient = 2 [json_name = "backoffCoefficient"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.protobuf.Duration maximum_interval = 3 [json_name = "maximumInterval"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>int32 maximum_attempts = 4 [json_name = "maximumAttempts"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated string non_retryable_error_types = 5 [json_name = "nonRetryableErrorTypes"];</code>
     */
     ...
     *           Maximum number of attempts. When exceeded the retries stop even if not expired yet.
     *           1 disables retries. 0 means unlimited (up to the timeouts)
     *     @type string[] $non_retryable_error_types
     *           Non-Retryable errors types. Will stop retrying if the error type matches this list. Note that
     *           this is not a substring match, the error *type* (not message) must match exactly.
     * }
     */
