...
class WorkerVersionCapabilities extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>string build_id = 1 [json_name = "buildId"];</code>
     */
    protected $build_id = '';
    /**
     ...
     * tasks.
     *
     * Generated from protobuf field <code>bool use_versioning = 2 [json_name = "useVersioning"];</code>
     */
    protected $use_versioning = false;
    /**
     * Must be sent if user has set a deployment series name (versioning-3).
     *
     * Generated from protobuf field <code>string deployment_series_name = 4 [json_name = "deploymentSeriesName"];</code>
     */
