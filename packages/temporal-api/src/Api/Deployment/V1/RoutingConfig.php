...
class RoutingConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.temporal.api.deployment.v1.WorkerDeploymentVersion current_deployment_version = 7 [json_name = "currentDeploymentVersion"];</code>
     */
    protected $current_deployment_version = null;
    /**
     * Deprecated. Use `current_deployment_version`.
     *
     * Generated from protobuf field <code>string current_version = 1 [json_name = "currentVersion", deprecated = true];</code>
     * @deprecated
     */
     ...
     *
     * Generated from protobuf field <code>.temporal.api.deployment.v1.WorkerDeploymentVersion ramping_deployment_version = 9 [json_name = "rampingDeploymentVersion"];</code>
     */
    protected $ramping_deployment_version = null;
    /**
     * Deprecated. Use `ramping_deployment_version`.
     *
     * Generated from protobuf field <code>string ramping_version = 2 [json_name = "rampingVersion", deprecated = true];</code>
     * @deprecated
     */
     ...
     *
     * Generated from protobuf field <code>float ramping_version_percentage = 3 [json_name = "rampingVersionPercentage"];</code>
     */
    protected $ramping_version_percentage = 0.0;
    /**
     * Last time current version was changed.
     *
     * Generated from protobuf field <code>.google.protobuf.Timestamp current_version_changed_time = 4 [json_name = "currentVersionChangedTime"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.protobuf.Timestamp ramping_version_changed_time = 5 [json_name = "rampingVersionChangedTime"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.protobuf.Timestamp ramping_version_percentage_changed_time = 6 [json_name = "rampingVersionPercentageChangedTime"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>int64 revision_number = 10 [json_name = "revisionNumber"];</code>
     */
