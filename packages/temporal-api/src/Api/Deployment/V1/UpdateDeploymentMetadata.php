...
{
    /**
     * Generated from protobuf field <code>map<string, .temporal.api.common.v1.Payload> upsert_entries = 1 [json_name = "upsertEntries"];</code>
     */
    private $upsert_entries;
    /**
     * List of keys to remove from the metadata.
     *
     * Generated from protobuf field <code>repeated string remove_entries = 2 [json_name = "removeEntries"];</code>
     */
