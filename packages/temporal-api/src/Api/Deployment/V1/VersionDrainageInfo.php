...
class VersionDrainageInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.temporal.api.enums.v1.VersionDrainageStatus status = 1 [json_name = "status"];</code>
     */
    protected $status = 0;
    /**
     * Last time the drainage status changed.
     *
     * Generated from protobuf field <code>.google.protobuf.Timestamp last_changed_time = 2 [json_name = "lastChangedTime"];</code>
     */
    protected $last_changed_time = null;
    /**
     * Last time the system checked for drainage of this version.
     *
     * Generated from protobuf field <code>.google.protobuf.Timestamp last_checked_time = 3 [json_name = "lastCheckedTime"];</code>
     */
