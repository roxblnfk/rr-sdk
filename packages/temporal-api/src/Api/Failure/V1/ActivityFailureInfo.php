...
class ActivityFailureInfo extends \Google\Protobuf\Internal\Message
{
    ...
    protected $identity = '';
    /**
     * Generated from protobuf field <code>.temporal.api.common.v1.ActivityType activity_type = 4 [json_name = "activityType"];</code>
     */
    protected $activity_type = null;
    /**
     * Generated from protobuf field <code>string activity_id = 5 [json_name = "activityId"];</code>
     */
    protected $activity_id = '';
    /**
     * Generated from protobuf field <code>.temporal.api.enums.v1.RetryState retry_state = 6 [json_name = "retryState"];</code>
     */
