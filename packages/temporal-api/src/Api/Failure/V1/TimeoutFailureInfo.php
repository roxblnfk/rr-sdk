...
{
    /**
     * Generated from protobuf field <code>.temporal.api.enums.v1.TimeoutType timeout_type = 1 [json_name = "timeoutType"];</code>
     */
    protected $timeout_type = 0;
    /**
     * Generated from protobuf field <code>.temporal.api.common.v1.Payloads last_heartbeat_details = 2 [json_name = "lastHeartbeatDetails"];</code>
     */
