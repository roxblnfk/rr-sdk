...
class ChildWorkflowExecutionFailedEventAttributes extends \Google\Protobuf\Internal\Message
{
    ...
    protected $namespace = '';
    /**
     * Generated from protobuf field <code>string namespace_id = 8 [json_name = "namespaceId"];</code>
     */
    ...
    /**
     * Generated from protobuf field <code>.temporal.api.common.v1.WorkflowType workflow_type = 4 [json_name = "workflowType"];</code>
     */
    protected $workflow_type = null;
    /**
     * Id of the `START_CHILD_WORKFLOW_EXECUTION_INITIATED` event which this event corresponds to
     *
     * Generated from protobuf field <code>int64 initiated_event_id = 5 [json_name = "initiatedEventId"];</code>
     */
    protected $initiated_event_id = 0;
    /**
     * Id of the `CHILD_WORKFLOW_EXECUTION_STARTED` event which this event corresponds to
     *
     * Generated from protobuf field <code>int64 started_event_id = 6 [json_name = "startedEventId"];</code>
     */
    protected $started_event_id = 0;
    /**
     * Generated from protobuf field <code>.temporal.api.enums.v1.RetryState retry_state = 7 [json_name = "retryState"];</code>
     */
