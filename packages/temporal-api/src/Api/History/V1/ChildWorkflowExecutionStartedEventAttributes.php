...
class ChildWorkflowExecutionStartedEventAttributes extends \Google\Protobuf\Internal\Message
{
    ...
    protected $namespace = '';
    /**
     * Generated from protobuf field <code>string namespace_id = 6 [json_name = "namespaceId"];</code>
     */
    protected $namespace_id = '';
    /**
     * Id of the `START_CHILD_WORKFLOW_EXECUTION_INITIATED` event which this event corresponds to
     *
     * Generated from protobuf field <code>int64 initiated_event_id = 2 [json_name = "initiatedEventId"];</code>
     */
