...
class MarkerRecordedEventAttributes extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>string marker_name = 1 [json_name = "markerName"];</code>
     */
    protected $marker_name = '';
    /**
     * Serialized information recorded in the marker
     *
     * Generated from protobuf field <code>map<string, .temporal.api.common.v1.Payloads> details = 2 [json_name = "details"];</code>
     */
    private $details;
    /**
