...
class RequestCancelExternalWorkflowExecutionInitiatedEventAttributes extends \Google\Protobuf\Internal\Message
{
     ...
     * Deprecated.
     *
     * Generated from protobuf field <code>string control = 4 [json_name = "control", deprecated = true];</code>
     * @deprecated
     */
    protected $control = '';
    /**
     ...
     *
     * Generated from protobuf field <code>bool child_workflow_only = 5 [json_name = "childWorkflowOnly"];</code>
     */
