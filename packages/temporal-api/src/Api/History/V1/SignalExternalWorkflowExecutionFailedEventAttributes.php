...
{
    /**
     * Generated from protobuf field <code>.temporal.api.enums.v1.SignalExternalWorkflowExecutionFailedCause cause = 1 [json_name = "cause"];</code>
     */
    protected $cause = 0;
    /**
     * The `WORKFLOW_TASK_COMPLETED` event which this command was reported with
     *
     * Generated from protobuf field <code>int64 workflow_task_completed_event_id = 2 [json_name = "workflowTaskCompletedEventId"];</code>
     */
