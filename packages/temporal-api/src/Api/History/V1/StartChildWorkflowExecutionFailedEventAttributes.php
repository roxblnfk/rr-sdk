...
class StartChildWorkflowExecutionFailedEventAttributes extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>.temporal.api.enums.v1.StartChildWorkflowExecutionFailedCause cause = 4 [json_name = "cause"];</code>
     */
    protected $cause = 0;
    /**
     * Deprecated.
     *
     * Generated from protobuf field <code>string control = 5 [json_name = "control", deprecated = true];</code>
     * @deprecated
     */
    protected $control = '';
    /**
     ...
     *
     * Generated from protobuf field <code>int64 initiated_event_id = 6 [json_name = "initiatedEventId"];</code>
     */
