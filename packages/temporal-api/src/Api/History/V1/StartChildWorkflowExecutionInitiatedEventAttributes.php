...
class StartChildWorkflowExecutionInitiatedEventAttributes extends \Google\Protobuf\Internal\Message
{
    ...
    protected $namespace = '';
    /**
     * Generated from protobuf field <code>string namespace_id = 18 [json_name = "namespaceId"];</code>
     */
     ...
     * Deprecated.
     *
     * Generated from protobuf field <code>string control = 10 [json_name = "control", deprecated = true];</code>
     * @deprecated
     */
    protected $control = '';
    /**
     ...
     *
     * Generated from protobuf field <code>int64 workflow_task_completed_event_id = 11 [json_name = "workflowTaskCompletedEventId"];</code>
     */
    protected $workflow_task_completed_event_id = 0;
    /**
     * Default: WORKFLOW_ID_REUSE_POLICY_ALLOW_DUPLICATE.
     *
     * Generated from protobuf field <code>.temporal.api.enums.v1.WorkflowIdReusePolicy workflow_id_reuse_policy = 12 [json_name = "workflowIdReusePolicy"];</code>
     */
    protected $workflow_id_reuse_policy = 0;
    /**
     * Generated from protobuf field <code>.temporal.api.common.v1.RetryPolicy retry_policy = 13 [json_name = "retryPolicy"];</code>
     */
    protected $retry_policy = null;
    /**
     * If this child runs on a cron schedule, it will appear here
     *
     * Generated from protobuf field <code>string cron_schedule = 14 [json_name = "cronSchedule"];</code>
     */
    protected $cron_schedule = '';
    /**
     * Generated from protobuf field <code>.temporal.api.common.v1.Header header = 15 [json_name = "header"];</code>
     */
    protected $header = null;
    /**
     * Generated from protobuf field <code>.temporal.api.common.v1.Memo memo = 16 [json_name = "memo"];</code>
     */
    protected $memo = null;
    /**
     * Generated from protobuf field <code>.temporal.api.common.v1.SearchAttributes search_attributes = 17 [json_name = "searchAttributes"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>bool inherit_build_id = 19 [json_name = "inheritBuildId", deprecated = true];</code>
     * @deprecated
     */
     ...
     * Priority metadata
     *
     * Generated from protobuf field <code>.temporal.api.common.v1.Priority priority = 20 [json_name = "priority"];</code>
     */
