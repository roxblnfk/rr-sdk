...
class WorkflowExecutionSignaledEventAttributes extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>string signal_name = 1 [json_name = "signalName"];</code>
     */
    protected $signal_name = '';
    /**
     * Will be deserialized and provided as argument(s) to the signal handler
     *
     * Generated from protobuf field <code>.temporal.api.common.v1.Payloads input = 2 [json_name = "input"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.temporal.api.common.v1.Header header = 4 [json_name = "header"];</code>
     */
    protected $header = null;
    /**
     * Deprecated. This field is never respected and should always be set to false.
     *
     * Generated from protobuf field <code>bool skip_generate_workflow_task = 5 [json_name = "skipGenerateWorkflowTask", deprecated = true];</code>
     * @deprecated
     */
     ...
     *
     * Generated from protobuf field <code>.temporal.api.common.v1.WorkflowExecution external_workflow_execution = 6 [json_name = "externalWorkflowExecution"];</code>
     */
