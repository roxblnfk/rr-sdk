...
{
    /**
     * Generated from protobuf field <code>.temporal.api.enums.v1.RetryState retry_state = 1 [json_name = "retryState"];</code>
     */
    protected $retry_state = 0;
    /**
     * If another run is started by cron or retry, this contains the new run id.
     *
     * Generated from protobuf field <code>string new_execution_run_id = 2 [json_name = "newExecutionRunId"];</code>
     */
