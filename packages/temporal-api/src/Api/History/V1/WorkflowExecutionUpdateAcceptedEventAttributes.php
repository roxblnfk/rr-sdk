...
class WorkflowExecutionUpdateAcceptedEventAttributes extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>string accepted_request_message_id = 2 [json_name = "acceptedRequestMessageId"];</code>
     */
    protected $accepted_request_message_id = '';
    /**
     * The event ID used to sequence the original request message.
     *
     * Generated from protobuf field <code>int64 accepted_request_sequencing_event_id = 3 [json_name = "acceptedRequestSequencingEventId"];</code>
     */
     ...
     * update.
     *
     * Generated from protobuf field <code>.temporal.api.update.v1.Request accepted_request = 4 [json_name = "acceptedRequest"];</code>
     */
