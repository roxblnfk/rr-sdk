...
class WorkflowExecutionUpdateAdmittedEventAttributes extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.temporal.api.update.v1.Request request = 1 [json_name = "request"];</code>
     */
    protected $request = null;
    /**
     * An explanation of why this event was written to history.
     *
     * Generated from protobuf field <code>.temporal.api.enums.v1.UpdateAdmittedEventOrigin origin = 2 [json_name = "origin"];</code>
     */
    protected $origin = 0;
