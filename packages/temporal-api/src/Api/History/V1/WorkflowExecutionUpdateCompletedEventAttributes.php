...
class WorkflowExecutionUpdateCompletedEventAttributes extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.temporal.api.update.v1.Meta meta = 1 [json_name = "meta"];</code>
     */
    protected $meta = null;
    /**
     * The event ID indicating the acceptance of this update.
     *
     * Generated from protobuf field <code>int64 accepted_event_id = 3 [json_name = "acceptedEventId"];</code>
     */
