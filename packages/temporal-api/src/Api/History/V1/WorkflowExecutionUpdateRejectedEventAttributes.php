...
class WorkflowExecutionUpdateRejectedEventAttributes extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>string protocol_instance_id = 1 [json_name = "protocolInstanceId"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>string rejected_request_message_id = 2 [json_name = "rejectedRequestMessageId"];</code>
     */
    protected $rejected_request_message_id = '';
    /**
     * The event ID used to sequence the original request message.
     *
     * Generated from protobuf field <code>int64 rejected_request_sequencing_event_id = 3 [json_name = "rejectedRequestSequencingEventId"];</code>
     */
     ...
     * update.
     *
     * Generated from protobuf field <code>.temporal.api.update.v1.Request rejected_request = 4 [json_name = "rejectedRequest"];</code>
     */
