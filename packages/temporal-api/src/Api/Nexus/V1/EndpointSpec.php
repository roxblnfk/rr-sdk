...
class EndpointSpec extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.temporal.api.common.v1.Payload description = 2 [json_name = "description"];</code>
     */
    protected $description = null;
    /**
     * Target to route requests to.
     *
     * Generated from protobuf field <code>.temporal.api.nexus.v1.EndpointTarget target = 3 [json_name = "target"];</code>
     */
