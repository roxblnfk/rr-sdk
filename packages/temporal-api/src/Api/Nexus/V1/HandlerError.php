...
class HandlerError extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>string error_type = 1 [json_name = "errorType"];</code>
     */
    protected $error_type = '';
    /**
     * Generated from protobuf field <code>.temporal.api.nexus.v1.Failure failure = 2 [json_name = "failure"];</code>
     */
    protected $failure = null;
    /**
     * Retry behavior, defaults to the retry behavior of the error type as defined in the spec.
     *
     * Generated from protobuf field <code>.temporal.api.enums.v1.NexusHandlerErrorRetryBehavior retry_behavior = 3 [json_name = "retryBehavior"];</code>
     */
