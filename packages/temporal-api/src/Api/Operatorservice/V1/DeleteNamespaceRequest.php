...
class DeleteNamespaceRequest extends \Google\Protobuf\Internal\Message
{
    ...
    protected $namespace = '';
    /**
     * Generated from protobuf field <code>string namespace_id = 2 [json_name = "namespaceId"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.protobuf.Duration namespace_delete_delay = 3 [json_name = "namespaceDeleteDelay"];</code>
     */
     ...
     * @return $this
     */
    public function setNamespaceDeleteDelay(\Google\Protobuf\Duration|null $var)
    {
