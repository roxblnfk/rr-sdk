...
class ListSearchAttributesResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>map<string, .temporal.api.enums.v1.IndexedValueType> custom_attributes = 1 [json_name = "customAttributes"];</code>
     */
    private $custom_attributes;
    /**
     * Mapping between system (predefined) search attribute name to its IndexedValueType.
     *
     * Generated from protobuf field <code>map<string, .temporal.api.enums.v1.IndexedValueType> system_attributes = 2 [json_name = "systemAttributes"];</code>
     */
    private $system_attributes;
    /**
     * Mapping from the attribute name to the visibility storage native type.
     *
     * Generated from protobuf field <code>map<string, string> storage_schema = 3 [json_name = "storageSchema"];</code>
     */
