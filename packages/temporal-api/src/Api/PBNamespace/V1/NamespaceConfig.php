...
{
    /**
     * Generated from protobuf field <code>.google.protobuf.Duration workflow_execution_retention_ttl = 1 [json_name = "workflowExecutionRetentionTtl"];</code>
     */
    protected $workflow_execution_retention_ttl = null;
    /**
     * Generated from protobuf field <code>.temporal.api.namespace.v1.BadBinaries bad_binaries = 2 [json_name = "badBinaries"];</code>
     */
    protected $bad_binaries = null;
    /**
     * If unspecified (ARCHIVAL_STATE_UNSPECIFIED) then default server configuration is used.
     *
     * Generated from protobuf field <code>.temporal.api.enums.v1.ArchivalState history_archival_state = 3 [json_name = "historyArchivalState"];</code>
     */
    protected $history_archival_state = 0;
    /**
     * Generated from protobuf field <code>string history_archival_uri = 4 [json_name = "historyArchivalUri"];</code>
     */
    protected $history_archival_uri = '';
    /**
     * If unspecified (ARCHIVAL_STATE_UNSPECIFIED) then default server configuration is used.
     *
     * Generated from protobuf field <code>.temporal.api.enums.v1.ArchivalState visibility_archival_state = 5 [json_name = "visibilityArchivalState"];</code>
     */
    protected $visibility_archival_state = 0;
    /**
     * Generated from protobuf field <code>string visibility_archival_uri = 6 [json_name = "visibilityArchivalUri"];</code>
     */
    protected $visibility_archival_uri = '';
    /**
     * Map from field name to alias.
     *
     * Generated from protobuf field <code>map<string, string> custom_search_attribute_aliases = 7 [json_name = "customSearchAttributeAliases"];</code>
     */
