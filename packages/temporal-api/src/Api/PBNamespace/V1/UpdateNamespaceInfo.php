...
class UpdateNamespaceInfo extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>string owner_email = 2 [json_name = "ownerEmail"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>map<string, string> data = 3 [json_name = "data"];</code>
     */
    private $data;
    /**
     ...
     *
     * Generated from protobuf field <code>.temporal.api.enums.v1.NamespaceState state = 4 [json_name = "state"];</code>
     */
    protected $state = 0;
