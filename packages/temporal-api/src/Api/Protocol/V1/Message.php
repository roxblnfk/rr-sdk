...
class Message extends \Google\Protobuf\Internal\Message
{
     ...
     * belongs.
     *
     * Generated from protobuf field <code>string protocol_instance_id = 2 [json_name = "protocolInstanceId"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.protobuf.Any body = 5 [json_name = "body"];</code>
     */
    protected $body = null;
    ...
    /**
     * Generated from protobuf field <code>int64 event_id = 3 [json_name = "eventId"];</code>
     * @return int|string
     */
    ...
    /**
     * Generated from protobuf field <code>int64 command_index = 4 [json_name = "commandIndex"];</code>
     * @return int|string
     */
