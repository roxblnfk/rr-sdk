...
class WorkflowRuleSpec extends \Google\Protobuf\Internal\Message
{
     ...
     * - ExecutionStatus
     *
     * Generated from protobuf field <code>string visibility_query = 3 [json_name = "visibilityQuery"];</code>
     */
    protected $visibility_query = '';
    /**
     * WorkflowRuleAction to be taken when the rule is triggered and predicate is matched.
     *
     * Generated from protobuf field <code>repeated .temporal.api.rules.v1.WorkflowRuleAction actions = 4 [json_name = "actions"];</code>
     */
    private $actions;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.protobuf.Timestamp expiration_time = 5 [json_name = "expirationTime"];</code>
     */
     ...
     *           - StartTime
     *           - ExecutionStatus
     *     @type \Temporal\Api\Rules\V1\WorkflowRuleAction[] $actions
     *           WorkflowRuleAction to be taken when the rule is triggered and predicate is matched.
    ...
    /**
     * Generated from protobuf field <code>.temporal.api.rules.v1.WorkflowRuleSpec.ActivityStartingTrigger activity_start = 2 [json_name = "activityStart"];</code>
     ...
     *
     * Generated from protobuf field <code>repeated .temporal.api.rules.v1.WorkflowRuleAction actions = 4 [json_name = "actions"];</code>
     * @return RepeatedField<\Temporal\Api\Rules\V1\WorkflowRuleAction>
     */
