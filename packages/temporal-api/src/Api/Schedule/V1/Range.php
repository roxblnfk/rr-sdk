...
class Range extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>int32 start = 1 [json_name = "start"];</code>
     */
    protected $start = 0;
    /**
     * End of range (inclusive).
     *
     * Generated from protobuf field <code>int32 end = 2 [json_name = "end"];</code>
     */
    protected $end = 0;
    /**
     * Step (optional, default 1).
     *
     * Generated from protobuf field <code>int32 step = 3 [json_name = "step"];</code>
     */
    protected $step = 0;
