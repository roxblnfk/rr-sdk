...
class Schedule extends \Google\Protobuf\Internal\Message
{
    ...
    protected $spec = null;
    /**
     * Generated from protobuf field <code>.temporal.api.schedule.v1.ScheduleAction action = 2 [json_name = "action"];</code>
     */
    protected $action = null;
    /**
     * Generated from protobuf field <code>.temporal.api.schedule.v1.SchedulePolicies policies = 3 [json_name = "policies"];</code>
     */
    protected $policies = null;
    /**
     * Generated from protobuf field <code>.temporal.api.schedule.v1.ScheduleState state = 4 [json_name = "state"];</code>
     */
