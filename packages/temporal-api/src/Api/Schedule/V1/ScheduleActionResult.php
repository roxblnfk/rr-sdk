...
class ScheduleActionResult extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.protobuf.Timestamp schedule_time = 1 [json_name = "scheduleTime"];</code>
     */
    protected $schedule_time = null;
    /**
     * Time that the action was taken (real time).
     *
     * Generated from protobuf field <code>.google.protobuf.Timestamp actual_time = 2 [json_name = "actualTime"];</code>
     */
    protected $actual_time = null;
    /**
     * If action was start_workflow:
     *
     * Generated from protobuf field <code>.temporal.api.common.v1.WorkflowExecution start_workflow_result = 11 [json_name = "startWorkflowResult"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.temporal.api.enums.v1.WorkflowExecutionStatus start_workflow_status = 12 [json_name = "startWorkflowStatus"];</code>
     */
     ...
     * @return $this
     */
    public function setActualTime(\Google\Protobuf\Timestamp|null $var)
    {
     ...
     * @return $this
     */
    public function setStartWorkflowResult(\Temporal\Api\Common\V1\WorkflowExecution|null $var)
    {
     ...
     * @return $this
     */
    public function setStartWorkflowStatus(int $var)
    {
