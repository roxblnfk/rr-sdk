...
class ScheduleListInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.temporal.api.schedule.v1.ScheduleSpec spec = 1 [json_name = "spec"];</code>
     */
    protected $spec = null;
    /**
     * From action:
     ...
     * From state:
     *
     * Generated from protobuf field <code>string notes = 3 [json_name = "notes"];</code>
     */
    protected $notes = '';
    /**
     * Generated from protobuf field <code>bool paused = 4 [json_name = "paused"];</code>
     */
    protected $paused = false;
    /**
     * From info (maybe fewer entries):
     *
     * Generated from protobuf field <code>repeated .temporal.api.schedule.v1.ScheduleActionResult recent_actions = 5 [json_name = "recentActions"];</code>
     */
    private $recent_actions;
    /**
     * Generated from protobuf field <code>repeated .google.protobuf.Timestamp future_action_times = 6 [json_name = "futureActionTimes"];</code>
     */
