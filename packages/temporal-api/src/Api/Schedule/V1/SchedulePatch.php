...
class SchedulePatch extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.temporal.api.schedule.v1.TriggerImmediatelyRequest trigger_immediately = 1 [json_name = "triggerImmediately"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .temporal.api.schedule.v1.BackfillRequest backfill_request = 2 [json_name = "backfillRequest"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>string pause = 3 [json_name = "pause"];</code>
     */
    protected $pause = '';
    /**
     * Generated from protobuf field <code>string unpause = 4 [json_name = "unpause"];</code>
     */
    protected $unpause = '';
