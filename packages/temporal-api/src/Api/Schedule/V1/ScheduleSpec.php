...
class ScheduleSpec extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .temporal.api.schedule.v1.StructuredCalendarSpec structured_calendar = 7 [json_name = "structuredCalendar"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated string cron_string = 8 [json_name = "cronString"];</code>
     */
    private $cron_string;
    /**
     * Calendar-based specifications of times.
     *
     * Generated from protobuf field <code>repeated .temporal.api.schedule.v1.CalendarSpec calendar = 1 [json_name = "calendar"];</code>
     */
    private $calendar;
    /**
     * Interval-based specifications of times.
     *
     * Generated from protobuf field <code>repeated .temporal.api.schedule.v1.IntervalSpec interval = 2 [json_name = "interval"];</code>
     */
    private $interval;
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .temporal.api.schedule.v1.CalendarSpec exclude_calendar = 3 [json_name = "excludeCalendar", deprecated = true];</code>
     * @deprecated
     */
    private $exclude_calendar;
    /**
     * Generated from protobuf field <code>repeated .temporal.api.schedule.v1.StructuredCalendarSpec exclude_structured_calendar = 9 [json_name = "excludeStructuredCalendar"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.protobuf.Timestamp end_time = 5 [json_name = "endTime"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.protobuf.Duration jitter = 6 [json_name = "jitter"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>string timezone_name = 10 [json_name = "timezoneName"];</code>
     */
    protected $timezone_name = '';
    /**
     * Generated from protobuf field <code>bytes timezone_data = 11 [json_name = "timezoneData"];</code>
     */
