...
class EnhancedStackTrace extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.temporal.api.sdk.v1.StackTraceSDKInfo sdk = 1 [json_name = "sdk"];</code>
     */
    protected $sdk = null;
    /**
     * Mapping of file path to file contents.
     *
     * Generated from protobuf field <code>map<string, .temporal.api.sdk.v1.StackTraceFileSlice> sources = 2 [json_name = "sources"];</code>
     */
    private $sources;
    /**
     * Collection of stacks captured.
     *
     * Generated from protobuf field <code>repeated .temporal.api.sdk.v1.StackTrace stacks = 3 [json_name = "stacks"];</code>
     */
    private $stacks;
