...
class AutoscalingPollerBehavior extends \Google\Protobuf\Internal\Message
{
     ...
     * Cannot be zero.
     *
     * Generated from protobuf field <code>int32 min_pollers = 1 [json_name = "minPollers"];</code>
     */
    protected $min_pollers = 0;
    /**
     * At most this many poll calls will ever be open at once. Must be >= `minimum`.
     *
     * Generated from protobuf field <code>int32 max_pollers = 2 [json_name = "maxPollers"];</code>
     */
     ...
     *  `minimum` and `maximum`.
     *
     * Generated from protobuf field <code>int32 initial_pollers = 3 [json_name = "initialPollers"];</code>
     */
