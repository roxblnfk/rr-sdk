...
class WorkflowTaskCompletedMetadata extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated uint32 core_used_flags = 1 [json_name = "coreUsedFlags"];</code>
     */
     ...
     *     aip.dev/not-precedent: These really shouldn't have negative values. --)
     *
     * Generated from protobuf field <code>repeated uint32 lang_used_flags = 2 [json_name = "langUsedFlags"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>string sdk_name = 3 [json_name = "sdkName"];</code>
     */
    protected $sdk_name = '';
    /**
     ...
     * since the last time recorded on the workflow (or be set on the first task).
     *
     * Generated from protobuf field <code>string sdk_version = 4 [json_name = "sdkVersion"];</code>
     */
