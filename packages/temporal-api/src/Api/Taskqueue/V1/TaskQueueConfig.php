...
class TaskQueueConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.temporal.api.taskqueue.v1.RateLimitConfig queue_rate_limit = 1 [json_name = "queueRateLimit"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.temporal.api.taskqueue.v1.RateLimitConfig fairness_keys_rate_limit_default = 2 [json_name = "fairnessKeysRateLimitDefault"];</code>
     */
    protected $fairness_keys_rate_limit_default = null;
    /**
     * If set, overrides the fairness weights for the corresponding fairness keys.
     *
     * Generated from protobuf field <code>map<string, float> fairness_weight_overrides = 3 [json_name = "fairnessWeightOverrides"];</code>
     */
