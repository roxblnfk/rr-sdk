...
class TaskQueueVersionInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>map<int32, .temporal.api.taskqueue.v1.TaskQueueTypeInfo> types_info = 1 [json_name = "typesInfo"];</code>
     */
    private $types_info;
    /**
     ...
     *
     * Generated from protobuf field <code>.temporal.api.enums.v1.BuildIdTaskReachability task_reachability = 2 [json_name = "taskReachability"];</code>
     */
