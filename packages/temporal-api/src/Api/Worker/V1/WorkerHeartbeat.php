...
class WorkerHeartbeat extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>string worker_instance_key = 1 [json_name = "workerInstanceKey"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>string worker_identity = 2 [json_name = "workerIdentity"];</code>
     */
    protected $worker_identity = '';
    /**
     * Worker host information.
     *
     * Generated from protobuf field <code>.temporal.api.worker.v1.WorkerHostInfo host_info = 3 [json_name = "hostInfo"];</code>
     */
    protected $host_info = null;
    /**
     * Task queue this worker is polling for tasks.
     *
     * Generated from protobuf field <code>string task_queue = 4 [json_name = "taskQueue"];</code>
     */
    ...
    /**
     * Generated from protobuf field <code>string sdk_name = 6 [json_name = "sdkName"];</code>
     */
    protected $sdk_name = '';
    /**
     * Generated from protobuf field <code>string sdk_version = 7 [json_name = "sdkVersion"];</code>
     */
    protected $sdk_version = '';
    /**
     * Worker status. Defined by SDK.
     *
     * Generated from protobuf field <code>.temporal.api.enums.v1.WorkerStatus status = 8 [json_name = "status"];</code>
     */
    protected $status = 0;
    /**
     * Worker start time.
     ...
     *
     * Generated from protobuf field <code>.google.protobuf.Timestamp start_time = 9 [json_name = "startTime"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.protobuf.Timestamp heartbeat_time = 10 [json_name = "heartbeatTime"];</code>
     */
    protected $heartbeat_time = null;
    /**
     * Elapsed time since the last heartbeat from the worker.
     *
     * Generated from protobuf field <code>.google.protobuf.Duration elapsed_since_last_heartbeat = 11 [json_name = "elapsedSinceLastHeartbeat"];</code>
     */
    protected $elapsed_since_last_heartbeat = null;
    /**
     * Generated from protobuf field <code>.temporal.api.worker.v1.WorkerSlotsInfo workflow_task_slots_info = 12 [json_name = "workflowTaskSlotsInfo"];</code>
     */
    protected $workflow_task_slots_info = null;
    /**
     * Generated from protobuf field <code>.temporal.api.worker.v1.WorkerSlotsInfo activity_task_slots_info = 13 [json_name = "activityTaskSlotsInfo"];</code>
     */
    protected $activity_task_slots_info = null;
    /**
     * Generated from protobuf field <code>.temporal.api.worker.v1.WorkerSlotsInfo nexus_task_slots_info = 14 [json_name = "nexusTaskSlotsInfo"];</code>
     */
    protected $nexus_task_slots_info = null;
    /**
     * Generated from protobuf field <code>.temporal.api.worker.v1.WorkerSlotsInfo local_activity_slots_info = 15 [json_name = "localActivitySlotsInfo"];</code>
     */
    protected $local_activity_slots_info = null;
    /**
     * Generated from protobuf field <code>.temporal.api.worker.v1.WorkerPollerInfo workflow_poller_info = 16 [json_name = "workflowPollerInfo"];</code>
     */
    protected $workflow_poller_info = null;
    /**
     * Generated from protobuf field <code>.temporal.api.worker.v1.WorkerPollerInfo workflow_sticky_poller_info = 17 [json_name = "workflowStickyPollerInfo"];</code>
     */
    protected $workflow_sticky_poller_info = null;
    /**
     * Generated from protobuf field <code>.temporal.api.worker.v1.WorkerPollerInfo activity_poller_info = 18 [json_name = "activityPollerInfo"];</code>
     */
    protected $activity_poller_info = null;
    /**
     * Generated from protobuf field <code>.temporal.api.worker.v1.WorkerPollerInfo nexus_poller_info = 19 [json_name = "nexusPollerInfo"];</code>
     */
    protected $nexus_poller_info = null;
    /**
     * A Workflow Task found a cached Workflow Execution to run against.
     *
     * Generated from protobuf field <code>int32 total_sticky_cache_hit = 20 [json_name = "totalStickyCacheHit"];</code>
     */
    protected $total_sticky_cache_hit = 0;
    /**
     * A Workflow Task did not find a cached Workflow execution to run against.
     *
     * Generated from protobuf field <code>int32 total_sticky_cache_miss = 21 [json_name = "totalStickyCacheMiss"];</code>
     */
    protected $total_sticky_cache_miss = 0;
    /**
     * Current cache size, expressed in number of Workflow Executions.
     *
     * Generated from protobuf field <code>int32 current_sticky_cache_size = 22 [json_name = "currentStickyCacheSize"];</code>
     */
    protected $current_sticky_cache_size = 0;
    /**
     * Plugins currently in use by this SDK.
     *
     * Generated from protobuf field <code>repeated .temporal.api.worker.v1.PluginInfo plugins = 23 [json_name = "plugins"];</code>
     */
    private $plugins;
