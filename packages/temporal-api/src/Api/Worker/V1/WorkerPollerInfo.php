...
class WorkerPollerInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>int32 current_pollers = 1 [json_name = "currentPollers"];</code>
     */
    protected $current_pollers = 0;
    /**
     * Generated from protobuf field <code>.google.protobuf.Timestamp last_successful_poll_time = 2 [json_name = "lastSuccessfulPollTime"];</code>
     */
    protected $last_successful_poll_time = null;
    /**
     * Set true if the number of concurrent pollers is auto-scaled
     *
     * Generated from protobuf field <code>bool is_autoscaling = 3 [json_name = "isAutoscaling"];</code>
     */
