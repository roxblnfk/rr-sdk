...
class WorkerSlotsInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>int32 current_available_slots = 1 [json_name = "currentAvailableSlots"];</code>
     */
    protected $current_available_slots = 0;
    /**
     * Number of slots used by the worker for specific tasks.
     *
     * Generated from protobuf field <code>int32 current_used_slots = 2 [json_name = "currentUsedSlots"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>string slot_supplier_kind = 3 [json_name = "slotSupplierKind"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>int32 total_processed_tasks = 4 [json_name = "totalProcessedTasks"];</code>
     */
    protected $total_processed_tasks = 0;
    /**
     * Total number of failed tasks processed by the worker so far.
     *
     * Generated from protobuf field <code>int32 total_failed_tasks = 5 [json_name = "totalFailedTasks"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>int32 last_interval_processed_tasks = 6 [json_name = "lastIntervalProcessedTasks"];</code>
     */
    protected $last_interval_processed_tasks = 0;
    /**
     * Number of failed tasks processed since the last heartbeat from the worker.
     *
     * Generated from protobuf field <code>int32 last_interval_failure_tasks = 7 [json_name = "lastIntervalFailureTasks"];</code>
     */
