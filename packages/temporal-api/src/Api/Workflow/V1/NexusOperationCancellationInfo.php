...
class NexusOperationCancellationInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.protobuf.Timestamp requested_time = 1 [json_name = "requestedTime"];</code>
     */
    protected $requested_time = null;
    /**
     * Generated from protobuf field <code>.temporal.api.enums.v1.NexusOperationCancellationState state = 2 [json_name = "state"];</code>
     */
    protected $state = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>int32 attempt = 3 [json_name = "attempt"];</code>
     */
    protected $attempt = 0;
    /**
     * The time when the last attempt completed.
     *
     * Generated from protobuf field <code>.google.protobuf.Timestamp last_attempt_complete_time = 4 [json_name = "lastAttemptCompleteTime"];</code>
     */
    protected $last_attempt_complete_time = null;
    /**
     * The last attempt's failure, if any.
     *
     * Generated from protobuf field <code>.temporal.api.failure.v1.Failure last_attempt_failure = 5 [json_name = "lastAttemptFailure"];</code>
     */
    protected $last_attempt_failure = null;
    /**
     * The time when the next attempt is scheduled.
     *
     * Generated from protobuf field <code>.google.protobuf.Timestamp next_attempt_schedule_time = 6 [json_name = "nextAttemptScheduleTime"];</code>
     */
    protected $next_attempt_schedule_time = null;
    /**
     * If the state is BLOCKED, blocked reason provides additional information.
     *
     * Generated from protobuf field <code>string blocked_reason = 7 [json_name = "blockedReason"];</code>
     */
