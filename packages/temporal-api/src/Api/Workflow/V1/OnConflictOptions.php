...
class OnConflictOptions extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>bool attach_request_id = 1 [json_name = "attachRequestId"];</code>
     */
    protected $attach_request_id = false;
    /**
     * Attaches the completion callbacks to the running workflow.
     *
     * Generated from protobuf field <code>bool attach_completion_callbacks = 2 [json_name = "attachCompletionCallbacks"];</code>
     */
    protected $attach_completion_callbacks = false;
    /**
     * Attaches the links to the WorkflowExecutionOptionsUpdatedEvent history event.
     *
     * Generated from protobuf field <code>bool attach_links = 3 [json_name = "attachLinks"];</code>
     */
