...
{
    /**
     * Generated from protobuf field <code>.temporal.api.enums.v1.PendingWorkflowTaskState state = 1 [json_name = "state"];</code>
     */
    protected $state = 0;
    /**
     * Generated from protobuf field <code>.google.protobuf.Timestamp scheduled_time = 2 [json_name = "scheduledTime"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.protobuf.Timestamp original_scheduled_time = 3 [json_name = "originalScheduledTime"];</code>
     */
    protected $original_scheduled_time = null;
    /**
     * Generated from protobuf field <code>.google.protobuf.Timestamp started_time = 4 [json_name = "startedTime"];</code>
     */
    ...
    /**
     * Generated from protobuf field <code>.temporal.api.enums.v1.PendingWorkflowTaskState state = 1 [json_name = "state"];</code>
     * @return int one of the values in {@see \Temporal\Api\Enums\V1\PendingWorkflowTaskState}
     */
    ...
    /**
     * Generated from protobuf field <code>.temporal.api.enums.v1.PendingWorkflowTaskState state = 1 [json_name = "state"];</code>
     * @param int $var one of the values in {@see \Temporal\Api\Enums\V1\PendingWorkflowTaskState}
     * @return $this
     */
     ...
     * @return $this
     */
    public function setOriginalScheduledTime(\Google\Protobuf\Timestamp|null $var)
    {
