...
class RequestIdInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.temporal.api.enums.v1.EventType event_type = 1 [json_name = "eventType"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>int64 event_id = 2 [json_name = "eventId"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>bool buffered = 3 [json_name = "buffered"];</code>
     */
     ...
     * @return $this
     */
    public function setBuffered(bool $var)
    {
        $this->buffered = $var;
