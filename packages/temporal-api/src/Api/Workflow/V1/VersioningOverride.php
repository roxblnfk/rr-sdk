...
class VersioningOverride extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.temporal.api.enums.v1.VersioningBehavior behavior = 1 [json_name = "behavior", deprecated = true];</code>
     * @deprecated
     */
     ...
     * Deprecated. Use `override.pinned.version`.
     *
     * Generated from protobuf field <code>string pinned_version = 9 [json_name = "pinnedVersion", deprecated = true];</code>
     * @deprecated
     */
     ...
     * Send the next workflow task to the Version specified in the override.
     *
     * Generated from protobuf field <code>.temporal.api.workflow.v1.VersioningOverride.PinnedOverride pinned = 3 [json_name = "pinned"];</code>
     ...
     * of its Task Queue when the next workflow task is dispatched.
     *
     * Generated from protobuf field <code>bool auto_upgrade = 4 [json_name = "autoUpgrade"];</code>
     * @return bool
     */
