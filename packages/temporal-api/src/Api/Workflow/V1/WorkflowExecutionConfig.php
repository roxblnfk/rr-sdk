...
class WorkflowExecutionConfig extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>.google.protobuf.Duration workflow_execution_timeout = 2 [json_name = "workflowExecutionTimeout"];</code>
     */
    protected $workflow_execution_timeout = null;
    /**
     * Generated from protobuf field <code>.google.protobuf.Duration workflow_run_timeout = 3 [json_name = "workflowRunTimeout"];</code>
     */
    protected $workflow_run_timeout = null;
    /**
     * Generated from protobuf field <code>.google.protobuf.Duration default_workflow_task_timeout = 4 [json_name = "defaultWorkflowTaskTimeout"];</code>
     */
    protected $default_workflow_task_timeout = null;
    /**
     * User metadata provided on start workflow.
     *
     * Generated from protobuf field <code>.temporal.api.sdk.v1.UserMetadata user_metadata = 5 [json_name = "userMetadata"];</code>
     */
     ...
     * @return $this
     */
    public function setDefaultWorkflowTaskTimeout(\Google\Protobuf\Duration|null $var)
    {
