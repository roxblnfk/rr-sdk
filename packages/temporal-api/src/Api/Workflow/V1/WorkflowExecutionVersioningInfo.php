...
class WorkflowExecutionVersioningInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.temporal.api.enums.v1.VersioningBehavior behavior = 1 [json_name = "behavior"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.temporal.api.deployment.v1.Deployment deployment = 2 [json_name = "deployment", deprecated = true];</code>
     * @deprecated
     */
     ...
     * Deprecated. Use `deployment_version`.
     *
     * Generated from protobuf field <code>string version = 5 [json_name = "version", deprecated = true];</code>
     * @deprecated
     */
    protected $version = '';
    /**
     ...
     *
     * Generated from protobuf field <code>.temporal.api.deployment.v1.WorkerDeploymentVersion deployment_version = 7 [json_name = "deploymentVersion"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.temporal.api.workflow.v1.VersioningOverride versioning_override = 3 [json_name = "versioningOverride"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.temporal.api.workflow.v1.DeploymentTransition deployment_transition = 4 [json_name = "deploymentTransition", deprecated = true];</code>
     * @deprecated
     */
     ...
     *
     * Generated from protobuf field <code>.temporal.api.workflow.v1.DeploymentVersionTransition version_transition = 6 [json_name = "versionTransition"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>int64 revision_number = 8 [json_name = "revisionNumber"];</code>
     */
