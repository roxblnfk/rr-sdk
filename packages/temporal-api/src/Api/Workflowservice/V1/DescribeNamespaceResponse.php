...
{
    /**
     * Generated from protobuf field <code>.temporal.api.namespace.v1.NamespaceInfo namespace_info = 1 [json_name = "namespaceInfo"];</code>
     */
    protected $namespace_info = null;
    /**
     * Generated from protobuf field <code>.temporal.api.namespace.v1.NamespaceConfig config = 2 [json_name = "config"];</code>
     */
    protected $config = null;
    /**
     * Generated from protobuf field <code>.temporal.api.replication.v1.NamespaceReplicationConfig replication_config = 3 [json_name = "replicationConfig"];</code>
     */
    protected $replication_config = null;
    /**
     * Generated from protobuf field <code>int64 failover_version = 4 [json_name = "failoverVersion"];</code>
     */
    protected $failover_version = 0;
    /**
     * Generated from protobuf field <code>bool is_global_namespace = 5 [json_name = "isGlobalNamespace"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .temporal.api.replication.v1.FailoverStatus failover_history = 6 [json_name = "failoverHistory"];</code>
     */
