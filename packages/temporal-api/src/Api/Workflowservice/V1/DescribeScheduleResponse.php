...
class DescribeScheduleResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.temporal.api.schedule.v1.Schedule schedule = 1 [json_name = "schedule"];</code>
     */
    protected $schedule = null;
    /**
     * Extra schedule state info.
     *
     * Generated from protobuf field <code>.temporal.api.schedule.v1.ScheduleInfo info = 2 [json_name = "info"];</code>
     */
    protected $info = null;
    /**
     * The memo and search attributes that the schedule was created with.
     *
     * Generated from protobuf field <code>.temporal.api.common.v1.Memo memo = 3 [json_name = "memo"];</code>
     */
    protected $memo = null;
    /**
     * Generated from protobuf field <code>.temporal.api.common.v1.SearchAttributes search_attributes = 4 [json_name = "searchAttributes"];</code>
     */
     ...
     * @return $this
     */
    public function setInfo(\Temporal\Api\Schedule\V1\ScheduleInfo|null $var)
    {
        $this->info = $var;
