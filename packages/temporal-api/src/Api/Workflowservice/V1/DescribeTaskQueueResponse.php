...
{
    /**
     * Generated from protobuf field <code>repeated .temporal.api.taskqueue.v1.PollerInfo pollers = 1 [json_name = "pollers"];</code>
     */
    private $pollers;
    /**
     ...
     *
     * Generated from protobuf field <code>.temporal.api.taskqueue.v1.TaskQueueStats stats = 5 [json_name = "stats"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>map<int32, .temporal.api.taskqueue.v1.TaskQueueStats> stats_by_priority_key = 8 [json_name = "statsByPriorityKey"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.temporal.api.taskqueue.v1.TaskQueueVersioningInfo versioning_info = 4 [json_name = "versioningInfo"];</code>
     */
    protected $versioning_info = null;
    /**
     * Only populated if report_task_queue_config is set to true.
     *
     * Generated from protobuf field <code>.temporal.api.taskqueue.v1.TaskQueueConfig config = 6 [json_name = "config"];</code>
     */
    protected $config = null;
    /**
     * Generated from protobuf field <code>.temporal.api.workflowservice.v1.DescribeTaskQueueResponse.EffectiveRateLimit effective_rate_limit = 7 [json_name = "effectiveRateLimit"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.temporal.api.taskqueue.v1.TaskQueueStatus task_queue_status = 2 [json_name = "taskQueueStatus", deprecated = true];</code>
     * @deprecated
     */
     ...
     *
     * Generated from protobuf field <code>map<string, .temporal.api.taskqueue.v1.TaskQueueVersionInfo> versions_info = 3 [json_name = "versionsInfo", deprecated = true];</code>
     * @deprecated
     */
