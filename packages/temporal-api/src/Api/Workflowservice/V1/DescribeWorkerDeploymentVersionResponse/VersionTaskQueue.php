...
class VersionTaskQueue extends \Google\Protobuf\Internal\Message
{
    ...
    protected $name = '';
    /**
     * Generated from protobuf field <code>.temporal.api.enums.v1.TaskQueueType type = 2 [json_name = "type"];</code>
     */
    protected $type = 0;
    /**
     * Only set if `report_task_queue_stats` is set on the request.
     *
     * Generated from protobuf field <code>.temporal.api.taskqueue.v1.TaskQueueStats stats = 3 [json_name = "stats"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>map<int32, .temporal.api.taskqueue.v1.TaskQueueStats> stats_by_priority_key = 4 [json_name = "statsByPriorityKey"];</code>
     */
