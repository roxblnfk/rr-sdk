...
class Operation extends \Google\Protobuf\Internal\Message
{
     ...
     * - setting `workflow_start_delay` is invalid
     *
     * Generated from protobuf field <code>.temporal.api.workflowservice.v1.StartWorkflowExecutionRequest start_workflow = 1 [json_name = "startWorkflow"];</code>
     ...
     * - setting `workflow_execution.run_id` is invalid
     *
     * Generated from protobuf field <code>.temporal.api.workflowservice.v1.UpdateWorkflowExecutionRequest update_workflow = 2 [json_name = "updateWorkflow"];</code>
