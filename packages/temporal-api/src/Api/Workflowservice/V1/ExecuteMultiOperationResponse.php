...
{
    /**
     * Generated from protobuf field <code>repeated .temporal.api.workflowservice.v1.ExecuteMultiOperationResponse.Response responses = 1 [json_name = "responses"];</code>
     */
    private $responses;
