...
class GetSystemInfoResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>string server_version = 1 [json_name = "serverVersion"];</code>
     */
    protected $server_version = '';
    /**
     * All capabilities the system supports.
     *
     * Generated from protobuf field <code>.temporal.api.workflowservice.v1.GetSystemInfoResponse.Capabilities capabilities = 2 [json_name = "capabilities"];</code>
     */
