...
class ListClosedWorkflowExecutionsRequest extends \Google\Protobuf\Internal\Message
{
    ...
    protected $namespace = '';
    /**
     * Generated from protobuf field <code>int32 maximum_page_size = 2 [json_name = "maximumPageSize"];</code>
     */
    ...
    /**
     * Generated from protobuf field <code>.temporal.api.filter.v1.StartTimeFilter start_time_filter = 4 [json_name = "startTimeFilter"];</code>
     */
    ...
    /**
     * Generated from protobuf field <code>.temporal.api.filter.v1.WorkflowExecutionFilter execution_filter = 5 [json_name = "executionFilter"];</code>
    ...
    /**
     * Generated from protobuf field <code>.temporal.api.filter.v1.WorkflowTypeFilter type_filter = 6 [json_name = "typeFilter"];</code>
    ...
    /**
     * Generated from protobuf field <code>.temporal.api.filter.v1.StatusFilter status_filter = 7 [json_name = "statusFilter"];</code>
     ...
     * @return $this
     */
    public function setStatusFilter(\Temporal\Api\Filter\V1\StatusFilter|null $var)
    {
