...
{
    /**
     * Generated from protobuf field <code>repeated .temporal.api.rules.v1.WorkflowRule rules = 1 [json_name = "rules"];</code>
     */
    private $rules;
    /**
     ...
     *
     *     @type \Temporal\Api\Rules\V1\WorkflowRule[] $rules
    ...
    /**
     * Generated from protobuf field <code>repeated .temporal.api.rules.v1.WorkflowRule rules = 1 [json_name = "rules"];</code>
     * @return RepeatedField<\Temporal\Api\Rules\V1\WorkflowRule>
     */
