...
class PollWorkflowExecutionUpdateResponse extends \Google\Protobuf\Internal\Message
{
     ...
     * not be set.
     *
     * Generated from protobuf field <code>.temporal.api.update.v1.Outcome outcome = 1 [json_name = "outcome"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.temporal.api.enums.v1.UpdateWorkflowExecutionLifecycleStage stage = 2 [json_name = "stage"];</code>
     */
    protected $stage = 0;
    /**
     * Sufficient information to address this Update.
     *
     * Generated from protobuf field <code>.temporal.api.update.v1.UpdateRef update_ref = 3 [json_name = "updateRef"];</code>
     */
