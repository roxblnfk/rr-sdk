...
class PollWorkflowTaskQueueResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>int64 previous_started_event_id = 4 [json_name = "previousStartedEventId"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>int64 started_event_id = 5 [json_name = "startedEventId"];</code>
     */
    protected $started_event_id = 0;
    /**
     * Starting at 1, the number of attempts to complete this task by any worker.
     *
     * Generated from protobuf field <code>int32 attempt = 6 [json_name = "attempt"];</code>
     */
    protected $attempt = 0;
    /**
     ...
     * this call.
     *
     * Generated from protobuf field <code>int64 backlog_count_hint = 7 [json_name = "backlogCountHint"];</code>
     */
     ...
     * a workflow task.
     *
     * Generated from protobuf field <code>.temporal.api.history.v1.History history = 8 [json_name = "history"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>bytes next_page_token = 9 [json_name = "nextPageToken"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.temporal.api.query.v1.WorkflowQuery query = 10 [json_name = "query"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.temporal.api.taskqueue.v1.TaskQueue workflow_execution_task_queue = 11 [json_name = "workflowExecutionTaskQueue"];</code>
     */
    protected $workflow_execution_task_queue = null;
    /**
     * When this task was scheduled by the server
     *
     * Generated from protobuf field <code>.google.protobuf.Timestamp scheduled_time = 12 [json_name = "scheduledTime"];</code>
     */
    protected $scheduled_time = null;
    /**
     * When the current workflow task started event was generated, meaning the current attempt.
     *
     * Generated from protobuf field <code>.google.protobuf.Timestamp started_time = 13 [json_name = "startedTime"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>map<string, .temporal.api.query.v1.WorkflowQuery> queries = 14 [json_name = "queries"];</code>
     */
    private $queries;
    /**
     * Protocol messages piggybacking on a WFT as a transport
     *
     * Generated from protobuf field <code>repeated .temporal.api.protocol.v1.Message messages = 15 [json_name = "messages"];</code>
     */
    private $messages;
    /**
     * Server-advised information the SDK may use to adjust its poller count.
     *
     * Generated from protobuf field <code>.temporal.api.taskqueue.v1.PollerScalingDecision poller_scaling_decision = 16 [json_name = "pollerScalingDecision"];</code>
     */
