...
{
    /**
     * Generated from protobuf field <code>.temporal.api.deployment.v1.DeploymentInfo current_deployment_info = 1 [json_name = "currentDeploymentInfo"];</code>
     */
    protected $current_deployment_info = null;
    /**
     * Info of the deployment that was current before executing this operation.
     *
     * Generated from protobuf field <code>.temporal.api.deployment.v1.DeploymentInfo previous_deployment_info = 2 [json_name = "previousDeploymentInfo"];</code>
     */
