...
class SetWorkerDeploymentManagerRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * Empty will unset the field.
     *
     * Generated from protobuf field <code>string manager_identity = 3 [json_name = "managerIdentity"];</code>
     * @return string
     */
     ...
     * True will set `manager_identity` to `identity`.
     *
     * Generated from protobuf field <code>bool self = 4 [json_name = "self"];</code>
     * @return bool
     */
