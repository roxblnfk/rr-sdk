...
class SignalWithStartWorkflowExecutionRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>string signal_name = 12 [json_name = "signalName"];</code>
     */
    protected $signal_name = '';
    /**
     * Serialized value(s) to provide with the signal
     *
     * Generated from protobuf field <code>.temporal.api.common.v1.Payloads signal_input = 13 [json_name = "signalInput"];</code>
     */
    protected $signal_input = null;
    /**
     * Deprecated.
     *
     * Generated from protobuf field <code>string control = 14 [json_name = "control", deprecated = true];</code>
     * @deprecated
     */
    protected $control = '';
    /**
     ...
     *
     * Generated from protobuf field <code>.temporal.api.common.v1.RetryPolicy retry_policy = 15 [json_name = "retryPolicy"];</code>
     */
    protected $retry_policy = null;
    /**
     * See https://docs.temporal.io/docs/content/what-is-a-temporal-cron-job/
     *
     * Generated from protobuf field <code>string cron_schedule = 16 [json_name = "cronSchedule"];</code>
     */
    protected $cron_schedule = '';
    /**
     * Generated from protobuf field <code>.temporal.api.common.v1.Memo memo = 17 [json_name = "memo"];</code>
     */
    protected $memo = null;
    /**
     * Generated from protobuf field <code>.temporal.api.common.v1.SearchAttributes search_attributes = 18 [json_name = "searchAttributes"];</code>
     */
    protected $search_attributes = null;
    /**
     * Generated from protobuf field <code>.temporal.api.common.v1.Header header = 19 [json_name = "header"];</code>
     */
     ...
     * Priority metadata
     *
     * Generated from protobuf field <code>.temporal.api.common.v1.Priority priority = 26 [json_name = "priority"];</code>
     */
