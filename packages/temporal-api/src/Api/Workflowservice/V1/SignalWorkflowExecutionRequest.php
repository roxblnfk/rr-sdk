...
class SignalWorkflowExecutionRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * Deprecated.
     *
     * Generated from protobuf field <code>string control = 7 [json_name = "control", deprecated = true];</code>
     * @deprecated
     */
    protected $control = '';
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .temporal.api.common.v1.Link links = 10 [json_name = "links"];</code>
     */
    private $links;
