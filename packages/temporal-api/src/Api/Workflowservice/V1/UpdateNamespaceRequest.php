...
class UpdateNamespaceRequest extends \Google\Protobuf\Internal\Message
{
    ...
    protected $namespace = '';
    /**
     * Generated from protobuf field <code>.temporal.api.namespace.v1.UpdateNamespaceInfo update_info = 2 [json_name = "updateInfo"];</code>
     */
    protected $update_info = null;
    /**
     * Generated from protobuf field <code>.temporal.api.namespace.v1.NamespaceConfig config = 3 [json_name = "config"];</code>
     */
    protected $config = null;
    /**
     * Generated from protobuf field <code>.temporal.api.replication.v1.NamespaceReplicationConfig replication_config = 4 [json_name = "replicationConfig"];</code>
     */
    protected $replication_config = null;
    /**
     * Generated from protobuf field <code>string security_token = 5 [json_name = "securityToken"];</code>
     */
    protected $security_token = '';
    /**
     * Generated from protobuf field <code>string delete_bad_binary = 6 [json_name = "deleteBadBinary"];</code>
     */
    protected $delete_bad_binary = '';
    /**
     * promote local namespace to global namespace. Ignored if namespace is already global namespace.
     *
     * Generated from protobuf field <code>bool promote_namespace = 7 [json_name = "promoteNamespace"];</code>
     */
