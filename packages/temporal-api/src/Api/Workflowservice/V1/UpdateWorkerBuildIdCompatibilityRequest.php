...
class UpdateWorkerBuildIdCompatibilityRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *     aip.dev/not-precedent: In makes perfect sense here. --)
     *
     * Generated from protobuf field <code>string add_new_build_id_in_new_default_set = 3 [json_name = "addNewBuildIdInNewDefaultSet"];</code>
     * @return string
     */
     ...
     * Adds a new id to an existing compatible set, see sub-message definition for more.
     *
     * Generated from protobuf field <code>.temporal.api.workflowservice.v1.UpdateWorkerBuildIdCompatibilityRequest.AddNewCompatibleVersion add_new_compatible_build_id = 4 [json_name = "addNewCompatibleBuildId"];</code>
     ...
     *     aip.dev/not-precedent: Names are hard. --)
     *
     * Generated from protobuf field <code>string promote_set_by_build_id = 5 [json_name = "promoteSetByBuildId"];</code>
     * @return string
     */
     ...
     *     aip.dev/not-precedent: Within makes perfect sense here. --)
     *
     * Generated from protobuf field <code>string promote_build_id_within_set = 6 [json_name = "promoteBuildIdWithinSet"];</code>
     * @return string
     */
     ...
     * also result in a split set, which this operation can repair.
     *
     * Generated from protobuf field <code>.temporal.api.workflowservice.v1.UpdateWorkerBuildIdCompatibilityRequest.MergeSets merge_sets = 7 [json_name = "mergeSets"];</code>
