...
class UpdateWorkerVersioningRulesRequest extends \Google\Protobuf\Internal\Message
{
    ...
    protected $namespace = '';
    /**
     * Generated from protobuf field <code>string task_queue = 2 [json_name = "taskQueue"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>bytes conflict_token = 3 [json_name = "conflictToken"];</code>
     */
    ...
    /**
     * Generated from protobuf field <code>.temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.InsertBuildIdAssignmentRule insert_assignment_rule = 4 [json_name = "insertAssignmentRule"];</code>
    ...
    /**
     * Generated from protobuf field <code>.temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.ReplaceBuildIdAssignmentRule replace_assignment_rule = 5 [json_name = "replaceAssignmentRule"];</code>
    ...
    /**
     * Generated from protobuf field <code>.temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.DeleteBuildIdAssignmentRule delete_assignment_rule = 6 [json_name = "deleteAssignmentRule"];</code>
    ...
    /**
     * Generated from protobuf field <code>.temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.AddCompatibleBuildIdRedirectRule add_compatible_redirect_rule = 7 [json_name = "addCompatibleRedirectRule"];</code>
    ...
    /**
     * Generated from protobuf field <code>.temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.ReplaceCompatibleBuildIdRedirectRule replace_compatible_redirect_rule = 8 [json_name = "replaceCompatibleRedirectRule"];</code>
    ...
    /**
     * Generated from protobuf field <code>.temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.DeleteCompatibleBuildIdRedirectRule delete_compatible_redirect_rule = 9 [json_name = "deleteCompatibleRedirectRule"];</code>
    ...
    /**
     * Generated from protobuf field <code>.temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.CommitBuildId commit_build_id = 10 [json_name = "commitBuildId"];</code>
